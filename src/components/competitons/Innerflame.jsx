...
import image1 from "./assets/Comp_Innerflame.png"; // Replace with the actual image for Innerflame
        ...
        <div className="w-[80vw] h-[80vh] laptop:h-[90vh] mx-[10vw] overflow-x-hidden overflow-y-scroll hide-scrollbar rounded-3xl laptop:my-[5vh] mobile:my-[10vh] fixed top-0 z-10 bg-white-custom ">
            ...
            <div className="pt-[5vh] laptop:pt-[9vh] grid h-[75vh]">
                ...
                <div className="w-[48vw] mx-auto mt-2.5">
                    ...
                    <div className="font-Akaya_Telivigala text-left mx-auto mb-2.5">
                        1. The time limit for the performance from an empty stage to an empty stage is 4 minutes. <br />
                        ...
                        7. Performances exceeding 4 minutes will lose all the points allocated for the time criteria and any other points lost will be at the discretion of the judges.
                    </div>
                </div>
            </div>
        </div>

...
import image1 from "./assets/Comp_valorant.jpg"; // Replace with the actual image for Humming
            ...
            <div className="pt-[5vh] laptop:pt-[9vh] grid h-[75vh]">
                ...
                <div className="w-[48vw] mx-auto mt-2.5">
                    ...
                    <div className="font-appetite text-left mx-auto mb-2.5">
                        1. Game will be in battle royale mode , all players must have latest version of VALORANT installed on their device with all classic maps downloaded. <br />
                        2. Only in-game voice chat should be used after the game is started till its competition. <br />
                        3. Hacking , Cheating , Use of unauthorized softwares are strictly prohabited. Players found violating these rules will be disquilified. <br />
                        4.  Waiting time is atmost 15-20 minutes between games. If a team / player fails to join the room in time  we will not be responsible.<br />
                        5. Competition will be held in online mode.<br />
                        6. Maps will be random.<br />
                        7.  By participating in the Valorant tournament organized by MIT AAROHAN players agree to abide by all tournament rules and regulations. The organizers reserve the right to modify rules, disqualify participants for misconduct, and resolve disputes at their discretion. Unauthorized third-party software is strictly prohibited. Prizes will be distributed according to the announced structure, and participants must provide accurate details for prize delivery.
                    </div>
                </div>
            </div>
        </div>

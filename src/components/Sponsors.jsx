  ...
  return (
    <div className=" bg-sponsors bg-cover w-[100vw] bg-center h-screen flex items-center justify-center text-black relative">
      <div className="w-full flex flex-col items-center justify-center">
        ...
        <div className="text-lg font-Akaya_Telivigala text-center mx-5 mb-[5vh] text-black">We've had many well-known and famous sponsors over the years, and here’s a glimpse of them. 
        </div>

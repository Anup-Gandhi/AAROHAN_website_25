  ...
  return (
    <>
      ...
      <nav className="fixed top-[5vh] left-1/2 transform -translate-x-1/2 z-30  flex">
        ...
        <ul className="flex font-Quintessential justify-end items-center list-none px-[15px] rounded-[4vh] bg-black bg-opacity-10 backdrop-blur-lg shadow-md">
      ...
      {/* Sidebar */}
      {isSidebarVisible && (
        <div className="fixed top-0 right-0 h-full w-[100vw] font-Quintessential z-40 text-center bg-black bg-opacity-80 backdrop-blur-lg shadow-md flex flex-col p-4">
          <button
            onClick={hideSidebar}
